...
var getInfo = async(event) =>{
   ...
   if (cityVal==="") {
      ...
      try{
         let url= `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=af8068fe471bbd8bf865b5a1704f5fd9`;
...
submitBtn && submitBtn.addEventListener('click', getInfo, false);
